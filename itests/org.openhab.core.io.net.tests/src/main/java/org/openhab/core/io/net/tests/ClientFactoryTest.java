...
/**
 * Tests for {@link HttpClientFactory} and {@link WebSocketFactory} implementations.
 *
...
public class ClientFactoryTest extends JavaOSGiTest {
    ...
    public void testHttp2Client() throws Exception {
        ...
        // initialize address
        InetSocketAddress address = new InetSocketAddress(HOST, getServer().getPort());
        ...
        try {
            ...
            // confirm stream is closed
            waitForAssert(() -> assertTrue(stream.isClosed()));
    ...
    public void testWebSocketClient() throws Exception {
        ...
        try {
            ...
            Future<org.eclipse.jetty.websocket.api.Session> session = client.connect(webSocket,
